      ...
      <div className='px-14 lg:p-0 w-full lg:w-9/12 m-auto'>
        <div className='w-full py-2 my-7 bg-gradient-to-l from-yellow-100 to-orange-100 rounded-md px-3 '>
          <h1 className='text-center text-gray-600 text-sm sm:text-base'>
            برای ارسال تیکت{' '}
           <Link to='/auth' className='text-purple-400 hover:text-purple-600 px-1 cursor-pointer'>
            ثبت نام  
            </Link>{' '}
            کنید و یا به حساب خود{''}
            <Link to="/auth" className='text-sky-400 hover:text-sky-600 px-1 cursor-pointer '>
             وارد
            </Link>{''}
            شوید !
          </h1>
